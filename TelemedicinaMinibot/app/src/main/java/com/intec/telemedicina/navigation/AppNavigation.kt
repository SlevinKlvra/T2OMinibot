...
@Composable
fun AppNavigation(mqttViewModel: MqttViewModel, numericPanelViewModel: NumericPanelViewModel, robotManager: RobotManager){
    ...
    NavHost(
        ...
        composable(AppScreens.HomeScreen.route){
            HomeScreen(navController = navController, mqttViewModel = mqttViewModel, robotManager = robotManager)
        }
